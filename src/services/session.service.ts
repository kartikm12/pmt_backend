...
export class SessionService {
  static async createSingleActiveSession(
    user: {
      id: string;
      email: string;
  ...
  static async validateActiveSession(sessionId: string, userId: string) {
  ...
  static async invalidateSession(sessionId: string, reason: string) {
