...
import { assignMembersSchema, createProjectSchema, updateProjectSchema } from "../validators/project.validator.js";
...
projectRouter.post("/:projectId/members", authorize(USER_ROLE.MANAGER, USER_ROLE.PROJECT_MANAGER, USER_ROLE.ADMIN), validate(assignMembersSchema), asyncHandler(ProjectController.assignMembers));
projectRouter.delete("/:projectId/members/:userId", authorize(USER_ROLE.MANAGER, USER_ROLE.PROJECT_MANAGER, USER_ROLE.ADMIN), asyncHandler(ProjectController.removeMember));
