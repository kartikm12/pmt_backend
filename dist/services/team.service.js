...
import { MEMBERSHIP_ROLE } from "../constants/enums.js";
...
export class TeamService {
    ...
    static async invite(actorUserId, input) {
    ...
    static async remove(userId, actorUserId) {
    ...
    static async update(userId, actorUserId, input) {
        const user = await prisma.user.findFirst({
            where: { id: userId, deletedAt: null }
        });
        if (!user) {
